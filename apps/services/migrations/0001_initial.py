# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2018-08-04 10:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', mezzanine.core.fields.FileField(max_length=255, verbose_name='Логотип')),
                ('short_content', models.TextField(max_length=200, verbose_name='Краткое содержание')),
                ('short_content_ru', models.TextField(max_length=200, null=True, verbose_name='Краткое содержание')),
                ('short_content_en', models.TextField(max_length=200, null=True, verbose_name='Краткое содержание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', mezzanine.core.fields.FileField(max_length=200, verbose_name='Фотография услуги')),
